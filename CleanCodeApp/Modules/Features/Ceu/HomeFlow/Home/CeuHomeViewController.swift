...
class CeuHomeViewController: UIViewController {
    ...
    @objc func didClickLogOut() {
        ...
        let vc = storyboard.instantiateViewController(withIdentifier: "CeuLoginViewController") as! CeuLoginViewController
