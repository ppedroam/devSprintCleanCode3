...
class FozHomeViewController: UIViewController {
    ...
    @objc func didClickLogOut() {
        ...
        let vc = storyboard.instantiateViewController(withIdentifier: "FozLoginViewController") as! FozLoginViewController
