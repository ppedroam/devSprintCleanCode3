...
class FozLoginViewController: UIViewController {
    ...
    func verifyLogin() {
        if let _ = UserDefaultsManager.UserInfos.shared.readSesion() {
            let vc = UINavigationController(rootViewController: FozHomeViewController())
    ...
    @IBAction func resetPasswordButton(_ sender: Any) {
        ...
        let vc = storyboard.instantiateViewController(withIdentifier: "FozResetPasswordViewController") as! FozResetPasswordViewController
    ...
    @IBAction func createAccountButton(_ sender: Any) {
        let controller = FozCreateAccountViewController()
...
extension FozLoginViewController {
