...
class LuzCreateAccountViewController: UIViewController {
...
// MARK: - Alamofire
extension LuzCreateAccountViewController {
...
extension LuzCreateAccountViewController: KeyboardAppearenceDelegate {
