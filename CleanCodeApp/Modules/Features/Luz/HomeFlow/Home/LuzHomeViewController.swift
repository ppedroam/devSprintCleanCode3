...
class LuzHomeViewController: UIViewController {
    ...
    @objc func didClickLogOut() {
        ...
        let vc = storyboard.instantiateViewController(withIdentifier: "LuzLoginViewController") as! LuzLoginViewController
