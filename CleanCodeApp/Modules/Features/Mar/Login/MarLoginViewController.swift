...
class MarLoginViewController: UIViewController {
    ...
    func verifyLogin() {
        if let _ = UserDefaultsManager.UserInfos.shared.readSesion() {
            let vc = UINavigationController(rootViewController: MarHomeViewController())
    ...
    @IBAction func resetPasswordButton(_ sender: Any) {
        let storyboard = UIStoryboard(name: "MarUser", bundle: nil)
        let vc = storyboard.instantiateViewController(withIdentifier: "MarResetPasswordViewController") as! MarResetPasswordViewController
    ...
    @IBAction func createAccountButton(_ sender: Any) {
        let controller = MarCreateAccountViewController()
...
extension MarLoginViewController {
