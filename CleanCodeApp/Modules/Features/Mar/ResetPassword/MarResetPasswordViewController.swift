...
class MarResetPasswordViewController: UIViewController {
    ...
    @IBAction func helpButton(_ sender: Any) {
        let vc = MarContactUsViewController()
    ...
    @IBAction func createAccountButton(_ sender: Any) {
        let newVc = MarCreateAccountViewController()
...
extension MarResetPasswordViewController {
