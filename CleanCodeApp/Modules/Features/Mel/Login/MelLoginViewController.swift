...
class MelLoginViewController: UIViewController {
    ...
    func verifyLogin() {
        if let _ = UserDefaultsManager.UserInfos.shared.readSesion() {
            let vc = UINavigationController(rootViewController: MelHomeViewController())
    ...
    @IBAction func resetPasswordButton(_ sender: Any) {
        let storyboard = UIStoryboard(name: "MelUser", bundle: nil)
        let vc = storyboard.instantiateViewController(withIdentifier: "MelResetPasswordViewController") as! MelResetPasswordViewController
    ...
    @IBAction func createAccountButton(_ sender: Any) {
        let controller = MelCreateAccountViewController()
...
extension MelLoginViewController {
