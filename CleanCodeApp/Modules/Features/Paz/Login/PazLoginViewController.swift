...
class PazLoginViewController: UIViewController {
    ...
    func verifyLogin() {
        if let _ = UserDefaultsManager.UserInfos.shared.readSesion() {
            let vc = UINavigationController(rootViewController: PazHomeViewController())
    ...
    @IBAction func resetPasswordButton(_ sender: Any) {
        ...
        let vc = storyboard.instantiateViewController(withIdentifier: "PazResetPasswordViewController") as! PazResetPasswordViewController
    ...
    @IBAction func createAccountButton(_ sender: Any) {
        let controller = PazCreateAccountViewController()
...
extension PazLoginViewController {
