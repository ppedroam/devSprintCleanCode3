...
class PazResetPasswordViewController: UIViewController {
    ...
    @IBAction func helpButton(_ sender: Any) {
        let vc = PazContactUsViewController()
    ...
    @IBAction func createAccountButton(_ sender: Any) {
        let newVc = PazCreateAccountViewController()
...
extension PazResetPasswordViewController {
