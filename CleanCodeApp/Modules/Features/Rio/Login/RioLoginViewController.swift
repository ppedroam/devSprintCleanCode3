...
class RioLoginViewController: UIViewController {
    ...
    func verifyLogin() {
        if let _ = UserDefaultsManager.UserInfos.shared.readSesion() {
            let vc = UINavigationController(rootViewController: RioHomeViewController())
    ...
    @IBAction func resetPasswordButton(_ sender: Any) {
        let storyboard = UIStoryboard(name: "RioUser", bundle: nil)
        let vc = storyboard.instantiateViewController(withIdentifier: "RioResetPasswordViewController") as! RioResetPasswordViewController
    ...
    @IBAction func createAccountButton(_ sender: Any) {
        let controller = RioCreateAccountViewController()
...
extension RioLoginViewController {
