...
class RumLoginViewController: UIViewController {
    ...
    func verifyLogin() {
        if let _ = UserDefaultsManager.UserInfos.shared.readSesion() {
            let vc = UINavigationController(rootViewController: RumHomeViewController())
    ...
    @IBAction func resetPasswordButton(_ sender: Any) {
        ...
        let vc = storyboard.instantiateViewController(withIdentifier: "RumResetPasswordViewController") as! RumResetPasswordViewController
    ...
    @IBAction func createAccountButton(_ sender: Any) {
        let controller = RumCreateAccountViewController()
...
extension RumLoginViewController {
