...
class SolLoginViewController: UIViewController {
    ...
    func verifyLogin() {
        if let _ = UserDefaultsManager.UserInfos.shared.readSesion() {
            let vc = UINavigationController(rootViewController: SolHomeViewController())
    ...
    @IBAction func resetPasswordButton(_ sender: Any) {
        ...
        let vc = storyboard.instantiateViewController(withIdentifier: "SolResetPasswordViewController") as! SolResetPasswordViewController
    ...
    @IBAction func createAccountButton(_ sender: Any) {
        let controller = SolCreateAccountViewController()
...
extension SolLoginViewController {
