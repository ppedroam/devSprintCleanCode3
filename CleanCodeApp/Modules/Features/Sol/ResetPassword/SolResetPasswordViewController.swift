...
class SolResetPasswordViewController: UIViewController {
    ...
    @IBAction func helpButton(_ sender: Any) {
        let vc = SolContactUsFactory.make()
    ...
    @IBAction func createAccountButton(_ sender: Any) {
        let newVc = SolCreateAccountViewController()
...
extension SolResetPasswordViewController {
