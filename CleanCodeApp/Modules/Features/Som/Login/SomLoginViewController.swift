...
class SomLoginViewController: UIViewController {
    ...
    func verifyLogin() {
        if let _ = UserDefaultsManager.UserInfos.shared.readSesion() {
            let vc = UINavigationController(rootViewController: SomHomeViewController())
    ...
    @IBAction func resetPasswordButton(_ sender: Any) {
        let storyboard = UIStoryboard(name: "SomUser", bundle: nil)
        let vc = storyboard.instantiateViewController(withIdentifier: "SomResetPasswordViewController") as! SomResetPasswordViewController
    ...
    @IBAction func createAccountButton(_ sender: Any) {
        let controller = SomCreateAccountViewController()
...
extension SomLoginViewController {
