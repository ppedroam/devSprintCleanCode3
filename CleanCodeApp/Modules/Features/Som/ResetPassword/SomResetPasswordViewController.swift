...
class SomResetPasswordViewController: UIViewController {
    ...
    @IBAction func helpButton(_ sender: Any) {
        let vc = SomContactUsViewController()
    ...
    @IBAction func createAccountButton(_ sender: Any) {
        let newVc = SomCreateAccountViewController()
...
extension SomResetPasswordViewController {
